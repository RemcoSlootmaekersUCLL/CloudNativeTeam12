...
// @Autowired
// public DbInitializer(WorkoutRepository workoutRepository, ExerciseRepository
// exerciseRepository,
...
// Workout workout2 = new Workout("user2", LocalDate.now().minusDays(1),
// List.of(
...
// // 4️⃣ Create Goals
// // =====================
// Goal goal1 = new Goal("user1", "Gain Muscle", LocalDate.now().plusMonths(3),
// LocalDate.now(), false);
// Goal goal2 = new Goal("user2", "Marathon Training",
// LocalDate.now().plusMonths(6), LocalDate.now(), false);
